...
githublogin.use(session({ secret: process.env.access_key, 
  resave: false, 
...
githublogin.get("/auth/github/", passport.authenticate("github",{scope: ["profile"]}));

githublogin.get(
  "/auth/github/callback",
  passport.authenticate("github", {
    failureRedirect: "https://stackoverflow.com/questions/22298033/nodejs-passport-error-oauthstrategy-requires-session-supporthtml",
  }),
  function (req, res) {
